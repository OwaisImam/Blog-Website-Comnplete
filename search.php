...
<?php include ("favicon.php"); ?>
	<title><?php echo $Keyword; ?> - <?php echo SiteTitle; ?></title>
...
<div class="content">
	 <div class="container">
		 ...
		 <div class="content-grids">
             <h4>Search result for <?php echo $Keyword; ?></h4>
             <br>
			 <div class="col-md-8 content-main">
			  <?php 
				$query="SELECT ID,BlogName,MetaDescription,Overview,Description,URL,Status,Categories,Image,Options,Ratings,RelatedBlog,DATE_FORMAT(DateAdded, '%D %b %Y / %r') AS Added,DateModified FROM blogs WHERE Status = 1 AND BlogName LIKE '%".dbinput($Keyword)."%'";
